...
public class CloseConnectionRuleBuilderTest {

    private RuleBasedController ruleBasedControllerMock = mock(RuleBasedController.class);
    private CloseConnectionRuleBuilder closeConnectionRuleBuilder =
            new CloseConnectionRuleBuilder(ruleBasedControllerMock);
    ...
    public void testCreateRule(){
        ...
        //WHEN
        final CloseConnectionRule closeConnectionRule =
                closeConnectionRuleBuilder.createRule(precondition, executor);

        //THEN
        final boolean applyResult = closeConnectionRule.applyOn(null);
