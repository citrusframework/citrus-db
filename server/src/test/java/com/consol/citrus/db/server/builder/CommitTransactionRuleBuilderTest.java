...
public class CommitTransactionRuleBuilderTest {

    private RuleBasedController ruleBasedControllerMock = mock(RuleBasedController.class);
    private CommitTransactionRuleBuilder commitTransactionRuleBuilder =
            new CommitTransactionRuleBuilder(ruleBasedControllerMock);
    ...
    public void testCreateRule(){
        ...
        //WHEN
        final CommitTransactionRule commitTransactionRule =
                commitTransactionRuleBuilder.createRule(precondition, executor);

        //THEN
        final boolean applyResult = commitTransactionRule.applyOn(null);
