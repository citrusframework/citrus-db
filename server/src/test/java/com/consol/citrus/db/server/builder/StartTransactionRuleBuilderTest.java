...
public class StartTransactionRuleBuilderTest {

    private RuleBasedController ruleBasedControllerMock = mock(RuleBasedController.class);
    private StartTransactionRuleBuilder startTransactionRuleBuilder =
            new StartTransactionRuleBuilder(ruleBasedControllerMock);
    ...
    public void testCreateRule(){
        ...
        //WHEN
        final StartTransactionRule startTransactionRule =
                startTransactionRuleBuilder.createRule(precondition, executor);

        //THEN
        final boolean applyResult = startTransactionRule.applyOn(null);
