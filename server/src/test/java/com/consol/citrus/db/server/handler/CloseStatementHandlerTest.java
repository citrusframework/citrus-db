...
public class CloseStatementHandlerTest {

    private final JdbcController controllerMock = mock(JdbcController.class);
    private final CloseStatementHandler closeStatementHandler = new CloseStatementHandler(controllerMock);
    ...
    public void testControllerIsUsed(){
        ...
        //WHEN
        closeStatementHandler.handle(requestMock, responseMock);

        //THEN
        verify(controllerMock).closeStatement();
    }
}