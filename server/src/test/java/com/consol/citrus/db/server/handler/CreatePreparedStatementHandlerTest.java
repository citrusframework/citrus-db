...
public class CreatePreparedStatementHandlerTest {

    private final JdbcController controllerMock = mock(JdbcController.class);
    private final CreatePreparedStatementHandler createPreparedStatementHandler =
            new CreatePreparedStatementHandler(controllerMock);
    ...
    public void testControllerIsUsed(){
        ...
        //WHEN
        createPreparedStatementHandler.handle(requestMock, responseMock);

        //THEN
        verify(controllerMock).createPreparedStatement(body);
    }
