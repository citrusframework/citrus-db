...
public class ExecuteXmlQueryHandlerTest {

    private final JdbcController controllerMock = mock(JdbcController.class);
    private final ExecuteXmlQueryHandler executeXmlQueryHandler = new ExecuteXmlQueryHandler(controllerMock);
    ...
    public void testControllerIsUsed(){
        ...
        final String expectedResponseType = "application/xml";

        //WHEN
        executeXmlQueryHandler.handle(requestMock, responseMock);
